                    ...
                    {nftData.map((item, index) =>
                        <div key={index} className='row'>
                            ...
                            <aside className='col-lg-4'>
                                <img style={{ maxWidth: '100%', maxHeight: '512px', margin: 'auto', borderRadius: '15px' }} src={item.extra.img} />
                            ...
                            <main className='col-lg-8'>
                                <div className='details-nft ps-lg-3'>
                                    ...
                                    <Link to={`/collection/${symbol}`} className='category-name text-info '>{item?.token?.collection.toUpperCase()}</Link>
                                    {/* <p className='description'>
                                    {nftData.description}
                                </p> */}
                                    <ul className='list-details-nft'>
                                        <li><span>List Price : </span>{item.token.price}</li>
                                        <li><span>Mint Address : </span>{item.tokenMint}</li>
                                        <li><span>Token Address : </span>{item.tokenAddress}</li>
                                    </ul>
