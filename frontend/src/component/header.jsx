            ...
            <div className='container'>
                <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start'>
                    <a href='/' className='col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 text-white text-decoration-none keychainify-checked'>
                        <svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' fill='currentColor' className='bi bi-currency-bitcoin' viewBox='0 0 16 16'>
                    ...
                    <ul className='nav col-lg-auto me-lg-auto'>
                        <li><a href='#' className='nav-link px-2 text-white keychainify-checked'>Collection</a></li>
                        <li><a href='#' className='nav-link px-2 text-white keychainify-checked'>About</a></li>
                        <li><a href='#' className='nav-link px-2 text-white keychainify-checked'>Contact Us</a></li>
                    </ul>
